...
/*	$FreeBSD: release/9.0.0/sys/dev/usb/wlan/if_zyd.c 223566 2011-06-26 11:37:24Z gavin $	*/
...
#include <sys/cdefs.h>
__FBSDID("$FreeBSD: release/9.0.0/sys/dev/usb/wlan/if_zyd.c 223566 2011-06-26 11:37:24Z gavin $");
