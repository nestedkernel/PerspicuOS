/*	$FreeBSD: release/9.0.0/sys/dev/ral/rt2560.c 220502 2011-04-09 14:45:50Z bschmidt $	*/
...
#include <sys/cdefs.h>
__FBSDID("$FreeBSD: release/9.0.0/sys/dev/ral/rt2560.c 220502 2011-04-09 14:45:50Z bschmidt $");
